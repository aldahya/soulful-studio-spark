      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2 p-6 shadow-soft">
          ...
          <div className="mt-6 flex gap-2">
            {wa && <Button asChild variant="outline" className="gap-2"><a href={wa} target="_blank" rel="noopener noreferrer"><MessageCircle className="h-4 w-4 text-success" /> واتساب</a></Button>}
          </div>
        </Card>
