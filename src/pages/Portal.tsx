  ...
  // src/pages/Portal.tsx — بوابة مجموعة المالكي التعليمية (صفحة اختيار المدرسة)
    ...
    import { ArrowLeft, ExternalLink, MapPin, ChevronDown, Star, PlayCircle } from 'lucide-react';
        ...
        <div dir="rtl" className="min-h-screen font-sans overflow-x-hidden" style={{ background: 'linear-gradient(160deg, hsl(195 40% 97%), hsl(178 30% 94%), hsl(195 20% 98%))' }}>
          ...
          <header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-teal-100 shadow-sm">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-teal-700 hover:bg-teal-50 border border-teal-200 transition-all font-medium"
              >
                <PlayCircle className="w-4 h-4" />
                <span className="hidden sm:inline">كيف يعمل النظام؟</span>
                <span className="sm:hidden">دليل الاستخدام</span>
              </button>
            </div>
          </header>
          ...
          <section className="relative overflow-hidden text-white" style={{ background: 'linear-gradient(140deg, hsl(195 50% 14%), hsl(178 55% 25%), hsl(172 45% 40%))' }}>
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-20 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                <button
                  onClick={() => navigate('/how-it-works')}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm font-bold transition-all backdrop-blur-sm"
                >
                  <PlayCircle className="w-4 h-4" />
                  كيف يعمل النظام؟
                </button>
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
            <div className="text-center mb-12">
              <span className="inline-block px-4 py-1.5 rounded-full bg-teal-100 text-teal-700 text-xs font-bold mb-4">مدارس المجموعة</span>
              <h2 className="text-3xl font-black text-gray-900 mb-3">اختر مدرستك</h2>
              <p className="text-gray-500 text-base max-w-md mx-auto">كل مدرسة لها نظامها المستقل — بياناتها وتقاريرها وحساباتها منفصلة تماماً</p>
            </div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className={`inline-block mt-1 px-2 py-0.5 rounded-full text-xs font-bold ${school.badgeBg} ${school.badgeText}`}>{school.subtitle}</span>
                        </div>
                      </div>
            ...
            <div className="mt-10 flex items-start gap-3 p-5 rounded-2xl bg-teal-50 border border-teal-200 max-w-2xl mx-auto">
              ...
              <div>
                ...
                <p className="text-xs text-teal-700 leading-relaxed">كل مدرسة تعمل بقاعدة بيانات مستقلة — طلابها وفصولها ومعلموها وتقاريرها معزولة تماماً.</p>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                ...
                <ul className="flex flex-wrap justify-center gap-4 text-sm text-gray-400">
                  {SCHOOLS.map((s) => (
                    <li key={s.id} className="flex items-center gap-2 cursor-pointer hover:text-teal-400 transition-colors" onClick={() => openSchool(s.id)}>
              ...
              <div className="pt-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
                ...
                <button onClick={() => navigate('/how-it-works')} className="hover:text-teal-400 transition-colors">
                  كيف يعمل النظام؟
                </button>
